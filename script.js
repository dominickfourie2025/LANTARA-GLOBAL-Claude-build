// Scroll-shrink header
  ...
  // NOTE: #employer-signup-form and #employer-signin-form now have real
  // Supabase handling in assets/js/employer-auth.js — no placeholder
  // handler needed here anymore.

  // Footer legal links (Privacy Policy / Cookie Policy / Terms) —
  // injected here so every page's footer gets them automatically
  // without hand-editing all 17 HTML files. Add a new page + update
  // the href/label pairs below if the legal pages ever move or grow.
  var isZh = document.documentElement.lang === 'zh-CN';
  var legalLinks = isZh
    ? [
        { href: 'privacy-policy.html', label: '隐私政策' },
        { href: 'cookie-policy.html', label: 'Cookie政策' },
        { href: 'terms.html', label: '服务条款' }
      ]
    : [
  ...
  document.querySelectorAll('.footer-bottom .legal').forEach(function (legalEl) {
    ...
    legalEl.insertBefore(frag, legalEl.firstChild);
  });
